export function TeamSection() {
  return (
    <section className="py-12 sm:py-16 lg:py-20" style={{ backgroundColor: 'rgba(0, 0, 0, 1)' }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-6 sm:mb-8 lg:mb-12">
          <h2 id="team" className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 sm:mb-6 pt-20 sm:pt-28 lg:pt-32 cursor-pointer transition-colors duration-200" 
            style={{ marginTop: '-5rem sm:-6rem lg:-8rem', color: 'rgba(31, 107, 255, 1)' }}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mb-12 sm:mb-16">
          ...
          <div className="text-center p-6 sm:p-8 rounded-2xl shadow-sm transition-all duration-200 cursor-pointer group animate-in slide-in-from-bottom duration-800 delay-500">
            <div className="mb-3 sm:mb-4 flex justify-center">
              <img 
                src="/fatikh.webp" 
                alt="Fatikh" 
          ...
          <div className="text-center p-6 sm:p-8 rounded-2xl shadow-sm transition-all duration-200 cursor-pointer group animate-in slide-in-from-bottom duration-800 delay-700">
            <div className="mb-3 sm:mb-4 flex justify-center">
              <img 
                src="/bizhan.png" 
                alt="Bizhan" 
        ...
        <div className="text-center animate-in slide-in-from-bottom duration-800 delay-900">
          <div className="p-6 sm:p-8 rounded-2xl border-2 transition-all duration-200 hover:border-opacity-80 group">
